...
public class ExtraFluidStorageBlockItem extends AbstractStorageContainerBlockItem implements UpgradeableStorageContainer {
    ...
    public ExtraFluidStorageBlockItem(Identifier id, Block block, ExtraFluidStorageVariant variant) {
        ...
        this.helpText = variant.hasCapacity()
                ...
                : IdentifierUtil.createTranslation("item", "creative_fluid_storage_block.help");
    }

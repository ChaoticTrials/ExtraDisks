...
//
//    public ExtraChemicalStorageDiskItem(Identifier id, ExtraChemicalStorageVariant variant) {
//        super(new Properties().stacksTo(1).setId(ResourceKey.create(Registries.ITEM, id)), RefinedStorageApi.INSTANCE.getStorageContainerItemHelper());

...
//
//    public ExtraChemicalStorageBlockItem(Identifier id, Block block, ExtraChemicalStorageVariant variant) {
//        super(block, new Properties().stacksTo(1).fireResistant().setId(ResourceKey.create(Registries.ITEM, id)).useBlockDescriptionPrefix(), RefinedStorageApi.INSTANCE.getStorageContainerItemHelper());

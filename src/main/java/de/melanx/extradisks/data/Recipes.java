...
public class Recipes extends RecipeProvider {
    ...
    protected void registerRecipes(@Nonnull Consumer<IFinishedRecipe> consumer) {
        ...
        this.registerPartRecipe(Registration.ITEM_STORAGE_PART.get(ExtraItemStorageType.TIER_10).get(), Registration.ITEM_STORAGE_PART.get(ExtraItemStorageType.TIER_9).get(), consumer);
        this.registerPartRecipe(Registration.ITEM_STORAGE_PART.get(ExtraItemStorageType.TIER_11).get(), Registration.ITEM_STORAGE_PART.get(ExtraItemStorageType.TIER_10).get(), consumer);
        this.registerPartRecipe(Registration.ITEM_STORAGE_PART.get(ExtraItemStorageType.TIER_12).get(), Registration.ITEM_STORAGE_PART.get(ExtraItemStorageType.TIER_11).get(), consumer);
        ...
        this.registerPartRecipe(Registration.FLUID_STORAGE_PART.get(ExtraFluidStorageType.TIER_8_FLUID).get(), Registration.FLUID_STORAGE_PART.get(ExtraFluidStorageType.TIER_7_FLUID).get(), consumer);
        this.registerPartRecipe(Registration.FLUID_STORAGE_PART.get(ExtraFluidStorageType.TIER_9_FLUID).get(), Registration.FLUID_STORAGE_PART.get(ExtraFluidStorageType.TIER_8_FLUID).get(), consumer);

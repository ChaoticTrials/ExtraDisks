...
//        public static final Map<ExtraChemicalStorageVariant, TagKey<Block>> STORAGE_BLOCKS_CHEMICAL = new HashMap<>(); todo Mekanism
...
//            }
        ...
        private static TagKey<Block> tag(String name) {
            return net.minecraft.tags.BlockTags.create(Identifier.fromNamespaceAndPath("refinedstorage", name));
        }
    }
...
//        public static final Map<ExtraChemicalStorageVariant, TagKey<Item>> DISKS_CHEMICAL = new HashMap<>();
        ...
        public static final TagKey<Item> OSMIUM_INGOTS = net.minecraft.tags.ItemTags.create(Identifier.fromNamespaceAndPath("c", "ingots/osmium"));
        public static final TagKey<Item> CHEMICAL_STORAGE_DISKS = net.minecraft.tags.ItemTags.create(Identifier.fromNamespaceAndPath("refinedstorage_mekanism_integration", "chemical_storage_disks"));
...
//            }
        ...
        private static TagKey<Item> tag(String name) {
            return net.minecraft.tags.ItemTags.create(Identifier.fromNamespaceAndPath("refinedstorage", name));
        }
    }

    public static class BlockTags extends BlockTagsProvider {
        public BlockTags(PackOutput output, CompletableFuture<HolderLookup.Provider> lookupProvider) {
            super(output, lookupProvider, ExtraDisks.MODID);
        }

        @Override
        protected void addTags(@Nonnull HolderLookup.Provider provider) {
            TagAppender<Block, Block> itemBlocksBuilder = this.tag(Blocks.ITEM_STORAGE_BLOCKS);
            for (ExtraItemStorageVariant variant : ExtraItemStorageVariant.values()) {
            ...
            TagAppender<Block, Block> fluidBlocksBuilder = this.tag(Blocks.FLUID_STORAGE_BLOCKS);
            for (ExtraFluidStorageVariant variant : ExtraFluidStorageVariant.values()) {
...
//            TagAppender<Block, Block> chemicalBlocksBuilder = this.tag(Blocks.CHEMICAL_STORAGE_BLOCKS); todo Mekanism
...
//                this.tag(tag).addOptional(Registration.CHEMICAL_STORAGE_BLOCK.get(variant).get());
...
//            }
    ...
    public static class ItemTags extends ItemTagsProvider {
        ...
        @Override
        protected void addTags(@Nonnull HolderLookup.Provider provider) {
            TagAppender<Item, Item> itemPartsBuilder = this.tag(Items.ITEM_PARTS);
            TagAppender<Item, Item> itemDisksBuilder = this.tag(Items.ITEM_DISKS);
            for (ExtraItemStorageVariant variant : ExtraItemStorageVariant.values()) {
            ...
            TagAppender<Item, Item> fluidPartsBuilder = this.tag(Items.FLUID_PARTS);
            TagAppender<Item, Item> fluidDisksBuilder = this.tag(Items.FLUID_DISKS);
            for (ExtraFluidStorageVariant variant : ExtraFluidStorageVariant.values()) {
...
//            TagAppender<Item, Item> chemicalPartsBuilder = this.tag(Items.CHEMICAL_PARTS); todo Mekanism
//            TagAppender<Item, Item> chemicalDisksBuilder = this.tag(Items.CHEMICAL_DISKS);
//            for (ExtraChemicalStorageVariant variant : ExtraChemicalStorageVariant.values()) {
//                TagKey<Item> tag = Items.PARTS_CHEMICAL.get(variant);
//                this.tag(tag).addOptional(Registration.CHEMICAL_STORAGE_PART.get(variant).get());
//                chemicalPartsBuilder.addOptionalTag(tag);
//
//                tag = Items.DISKS_CHEMICAL.get(variant);
//                this.tag(tag).addOptional(Registration.CHEMICAL_STORAGE_DISK.get(variant).get());
//                chemicalDisksBuilder.addOptionalTag(tag);
//            }

            this.tag(Items.PARTS).addTags(Items.ITEM_PARTS, Items.FLUID_PARTS);
            this.tag(Items.PARTS).addOptionalTag(Items.CHEMICAL_PARTS);
            this.tag(Items.DISKS).addTags(Items.ITEM_DISKS, Items.FLUID_DISKS);
            this.tag(Items.DISKS).addOptionalTag(Items.CHEMICAL_DISKS);
...
//            this.copy(Blocks.CHEMICAL_STORAGE_BLOCKS, Items.CHEMICAL_STORAGE_BLOCKS); todo Mekanism
//            for (ExtraChemicalStorageVariant variant : ExtraChemicalStorageVariant.values()) {
